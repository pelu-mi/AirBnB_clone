...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, line):
        ...
        """ Usage: 1. create <class name> | 2. <class name>.create() | Create an instance of a class, save it to JSON file
        and print the id.
        ------------------------------------------------------
    ...
    def do_show(self, line):
        """Usage: 1. show <class name> <id> | 2. <class name>.show(<id>) | Prints the string representation of an instance based on the
        classname and id
        ---------------------------------------------------------------
    ...
    def do_destroy(self, line):
        """Usage: 1. destroy <class name> <id> | 2. <class name>.delete(<id>) | Delete an instance based on the class name and id
    ...
    def do_all(self, line):
        """Usage: 1. all | 2. all <class name> | 3. <class name>.all() | Print all string representation of all instances based on the
    ...
    def do_update(self, line):
        """sage: 1. update <class name> <id> <attribute> <value> | \
            2. <class name>.update(<id> <attribute> <value>) \
            3. update <clas name> <id> <dictionary> \
            4. <class name>.update(<id> <dictionary>) \  Update an instance based on the class name and id by adding
